# 资源受限环境下大语言模型长文本推理的 $KV$ Cache 压缩与优化方法研究
...
| **核心目标** | 在可控模型质量损失与推理时延变化下，联合降低 $KV$ Cache 的容量与访问开销，提升资源受限环境中的长上下文部署能力。 |
...
| 第 $3$ 章 $KV$ Cache 压缩与优化机制设计 | `chapters/03_methodology.md` | 7,000--8,500 字 | 未开始 | 7 |
| 第 $4$ 章 $KV$ Cache 系统实现与推理优化 | `chapters/04_implementation.md` | 4,500--6,000 字 | 未开始 | 7 |
